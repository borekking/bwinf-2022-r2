...
\newcommand{\Aufgabe}{Bonusaufgabe - Zara Zackigs Zurueckkehr} % Aufgabennummer und Aufgabennamen angeben
...
\subsection{Anwendungsmoeglichkeit}
Dieser Loesungsweg hat also ebenbenfalls eine exponentielle Laufzeit und laesst sich nur anwenden, wenn die Loesungsmenge des homogenen Systems der Matrix klein genug ist, bezueglich der Anzahl an freien Variablen.\\
...
\\\\
Des Weiteren kann dieser Algorithmus auch auf Faelle angewendet, in welchen die Anzahl an freien Variablen zu grosz ist, um alle Moeglichkeiten auszuprobieren.\\
